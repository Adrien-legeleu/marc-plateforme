    ...
    <div className="space-y-32">
      <div className="bg-gradient-to-b from-white to-marcblue/70 px-5 rounded-[3rem] gap-20 pt-40 pb-10 w-full flex flex-col items-center justify-center ">
        ...
        <div className="grid grid-cols-3 h-[120px] sm:gap-10 gap-5 z-10 w-full max-w-4xl">
          <MagneticButton>
            <Button className="bg-gradient-to-b from-marcblue to-marcblue/40 flex flex-col gap-3 font-bold shadow-xl backdrop-blur-sm w-full h-full hover:bg-blue-600/60 cursor-pointer transition-colors sm:text-xl text-white sm:py-5 py-2 rounded-[3rem]">
