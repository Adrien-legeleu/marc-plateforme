...
const MultipleSelector = ({
  ...
  return (
    <Command
      ...
      className={cn(
        'h-auto overflow-visible bg-white rounded-3xl',
    ...
    >
      <div
        className={cn(
          'border-input  has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive relative min-h-[38px] rounded-3xl  text-sm transition-[color,box-shadow] outline-none  has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50',
          {
      ...
      >
        <div className="flex  flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'placeholder:text-muted-foreground/70 ml-5 flex-1 outline-none  disabled:cursor-not-allowed',
              {
      ...
      <div className="relative">
        ...
        >
          {open && (
            <CommandList
              className="bg-popover rounded-3xl text-popover-foreground bg-white shadow-lg outline-hidden"
              onMouseLeave={() => {
